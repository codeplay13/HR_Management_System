...
<table border="1">
				...
				<c:forEach items="${list}" var="i">
					<tr>
						...
						<td>${i.leaveReason}</td>
						<td>${i.leaveStatus}</td>
						<c:if test="${i.leaveStatus==0}">
						 <td><a href="approveLeave.html?id=${i.leaveId}&approvalStatus=a">Approve</a>
							<a href="approveLeave.html?id=${i.leaveId}&approvalStatus=d">Reject</a>
						</td> 
						</c:if>
