...
<body>
 <div class="w3-sidebar w3-light-grey w3-bar-block" style="width:25%">
	...
	<form method="post" action="recruitment.html">
		<h1>Add Project</h1>
		<p>Project ID: <br> <input type="text" name="projectId" required><br>
		<p>Skills: <br> <input type="text" name="skills" required><br><br>
		<p>Experience: <br> <input type="number" name="experience" required><br><br>
