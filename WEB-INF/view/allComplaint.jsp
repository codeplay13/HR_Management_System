...
<a:choose><a:when test="${complaints.size()==0}"><h1>No complaints</h1></a:when>
<a:when test="${complaints.size() != 0}">
<table border = "1">
<tr>
<th>PS Number</th>
<th>Time Added</th>
...
<a:forEach items="${complaints}" var="i">
<tr>
<td>${i.psno}</td>
...
<br><a href="getComplaintByPsno.html">Search Complaint by PsNo</a>
</div>
</body>
</html>