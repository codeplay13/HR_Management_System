...
<body>
 <div class="w3-sidebar w3-light-grey w3-bar-block" style="width:25%">
	...
	<form action = "getFeedbackByPsno.html" method="post">
<p>Enter PS Number:<br> <input type="text" name="psno"><br><br>
		<input type="submit" name="submit" value="Submit" />
<a:choose><a:when test="${feedback.size()==0}"><h1>No feedbacks</h1></a:when>
<a:when test="${feedback.size() != 0}">
<table border = "1">
<tr>
<th>PS Number</th>
<th>Time Added</th>
...
<a:forEach items="${feedback}" var="i">
<tr>
<td>${i.psno}</td>
